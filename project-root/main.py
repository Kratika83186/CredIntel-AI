...
st.set_page_config(page_title="CredIntel AI - Intelligent Corporate Credit Engine", page_icon="📊", layout="centered")
...
with st.sidebar:
    ...
    """)
    st.image("Lauki Finance.JPG", caption="CredIntel AI:Intelligent Corporate Credit Engine")  # Add a relevant image/logo.
